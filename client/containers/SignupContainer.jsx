...
const SignupContainer = () => {
    ...
    const signupHandler = () => {
        ...
        const userInputs = { email: email, firstName: firstName, lastName: lastName, username: username, password: password };
    ...
    return (
        <div className="login">
            ...
            <input type="text" id="signup-email" className="login-input" autoComplete='off' placeholder="Email"></input>
            <input type="text" id="signup-firstName" className="login-input" autoComplete='off' placeholder="First Name"></input>
            <input type="text" id="signup-lastName" className="login-input" autoComplete='off' placeholder="Last Name"></input>
            ...
            <button className="login-input" onClick={backTLogin}>Back to Login</button>
        </div >
    )
