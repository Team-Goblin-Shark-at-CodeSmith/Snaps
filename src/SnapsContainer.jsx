...
const SnapsContainer = () => {
    ...
    const handleAdd = (e) => {
        ...
        let translated = (async () => {
            const rawResponse = await fetch(
              "https://api.openai.com/v1/chat/completions",
              {
                ...
                headers: {
                  ...
                  Authorization: `Bearer ` + {secret.OPENAISECRETKEY},
                },
                body: JSON.stringify({
                  model: "gpt-3.5-turbo",
                  messages: [
            ...
            const text = content.choices[0].message.content.toString();
            popup(text);
