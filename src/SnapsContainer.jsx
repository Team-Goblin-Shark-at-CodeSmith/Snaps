...
const SnapsContainer = () => {
    ...
    const handleAdd = (e) => {
        ...
        let translated = (async () => {
              ...
              "https://api.openai.com/v1/chat/completions",
              {
                ...
                body: JSON.stringify({
                  ...
                  messages: [
                    {
                      role: "user",
                      content: "give me a list of ten exotic foods",
                    },
                  ],
                  temperature: 0.7,
                }),
            ...
            fetch('/my-snaps' , {
              ...
              body: JSON.stringify({ user_id: 3, title: userTitleInput, url: userUrlInput, snap_text: summary })
            })
            .then(res => res.json())
            .then(res => {
    ...
    return(
        <div id="snaps-container">
            ...
            <input type='title' id='titleInput' placeholder='Enter a title...'/>
